...
[_COLEMAKDH] = LAYOUT(
//,-----------------------------------------------------.                          ,-----------------------------------------------------.
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    LT(_SWITCH, KC_5),                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
//|--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------|
   LT(_NUMPAD, KC_TAB), KC_Q, KC_W, KC_F, KC_P, KC_B,                               KC_J,    KC_L,    KC_U,    MV_Y,    KC_SCLN, KC_BSPC,
//|--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------|
   KC_LSFT, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                               KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_RSFT,
//|--------+--------+--------+--------+--------+--------| ====== .        , ====== |--------+--------+--------+--------+--------+--------|
   XXXXXXX, MV_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_MUTE,          XXXXXXX, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
//|--------+--------+--------+--------+--------+--------| ====== |        | ====== |--------+--------+--------+--------+--------+--------|
...
//|--------+--------+--------+--------+--------+--------| ====== .        , ====== |--------+--------+--------+--------+--------+--------|
   _______, MV_HASH, MV_EXLM, MV_DLR,  MV_EURO, MV_BSLS, XXXXXXX,          XXXXXXX, MV_ASTR, MV_EQL,  MV_COLN, MV_LBRC, MV_RBRC, MV_RABK,
//|--------+--------+--------+--------+--------+--------| ====== |        | ====== |--------+--------+--------+--------+--------+--------|
                     _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______
//                  '--------+--------+--------+--------+--------'        '--------+--------+--------+--------+--------'
),
